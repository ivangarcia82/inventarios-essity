...
export function generateRemision(data: RemisionData): void {
  ...
  doc.setFontSize(9);
  doc.text(`Essity / Generando Ideas — Sistema de Inventarios`, margin, 20);
  ...
  doc.text(
    "Documento generado automáticamente por el Sistema de Inventarios Essity / Generando Ideas",
    W / 2,
    pageH - 10,
    { align: "center" }
  );
